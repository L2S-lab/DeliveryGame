...
if __name__ == "__main__":
    ...
    if audio=="english":ep_robot.play_audio(filename="Livraison/audio/english/start.wav").wait_for_completed()

    ep_led = ep_robot.led

    for _ in range(2):
        print("Début de la boucle")
        if audio=="francais":ep_robot.play_audio(filename="Livraison/audio/francais/position.wav").wait_for_completed()
        ...
        if audio=="francais":ep_robot.play_audio(filename="Livraison/audio/francais/cherche.wav").wait_for_completed()
        if audio=="english":ep_robot.play_audio(filename="Livraison/audio/english/before_find.wav").wait_for_completed()
        ...
        if audio=="francais":ep_robot.play_audio(filename="Livraison/audio/francais/go_to_ball.wav").wait_for_completed()
        ...
        print(total_angle)
        if audio=="english":ep_robot.play_audio(filename="Livraison/audio/english/got_the_ball.wav").wait_for_completed()
        if audio=="francais":ep_robot.play_audio(filename="Livraison/audio/francais/go_to_box.wav").wait_for_completed()
        ep_led.set_led(comp=led.COMP_BOTTOM_ALL, r=255, g=0, b=0, effect=led.EFFECT_BREATH)
        ...
        if audio=="francais":ep_robot.play_audio(filename="Livraison/audio/francais/depose.wav").wait_for_completed()
        if audio=="english":ep_robot.play_audio(filename="Livraison/audio/english/delivery_completed.wav").wait_for_completed()
    ...
    if audio=="francais":ep_robot.play_audio(filename="Livraison/audio/francais/finish.wav").wait_for_completed()
    if audio=="english":ep_robot.play_audio(filename="Livraison/audio/english/finish.wav").wait_for_completed()

    #Dance : 
    # if audio=="english" or audio=="francais":ep_robot.play_audio(filename="Livraison/audio/Champions.wav").wait_for_completed()
